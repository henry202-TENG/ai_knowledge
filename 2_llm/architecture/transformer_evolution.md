...
**Transformer Evolution** 指的是 Transformer 架構從 2017 年提出到現在的持續演進過程：
...
**演進主線**:
1. **架構變體**: Encoder-only → Decoder-only → 混合架構
2. **效率提升**: 稀疏注意力 → Flash Attention → 量化
3. **位置編碼**: Sinusoidal → RoPE → ALiBi
4. **模型擴展**: Dense → MoE → SSM
