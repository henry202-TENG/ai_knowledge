...
**Generation Strategies (生成策略)** 是控制 LLM 如何**選擇下一個 token** 的技術：
...
**關鍵參數**:
1. **Temperature**: 控制概率分布的「平滑度」
2. **Top-K**: 限制候選詞數量
3. **Top-P (Nucleus)**: 動態調整候選集合
4. **Repetition Penalty**: 防止重複
