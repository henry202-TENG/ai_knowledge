...
**DPO (Direct Preference Optimization)** 是一種**簡化的對齊訓練**技術：
...
│  │                              ↓                               │   │
│  │  Stage 3: PPO 強化學習                                        │   │
│  │  RM 評分 → Policy 梯度更新 → 對齊模型                         │   │
│  │  - 需要價值網路 (Value Network)                              │   │
│  │  - 需要複雜的 KL 約束                                         │   │
│  │  - 訓練不穩定                                                │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                              ↓                                       │
...
**核心創新**:
1. **繞過獎勵模型**: 直接從偏好數據學習
2. **簡化訓練流程**: 從 3 階段變 1 階段
3. **數學等價**: 論文證明 DPO ≈ RLHF
