...
**NVLink / NVSwitch** 是 NVIDIA 的**高速 GPU 互連**技術：
...
│  │                                                              │   │
│  │  問題: 所有 GPU 搶同一條 PCIe 通道                          │   │
│  │  頻寬: 32 GB/s ( PCIe Gen5 )                               │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                              ↓                                       │
│  NVLink + NVSwitch 時代:                                            │
│  ┌─────────────────────────────────────────────────────────────┐   │
...
**為何關鍵**:
1. **頻寬突破**: 從 PCIe 32 GB/s 到 NVLink 900 GB/s (28x)
2. **延遲降低**: P2P 通訊繞過 CPU
3. **支撐大規模**: Tensor Parallelism 的硬體基礎
