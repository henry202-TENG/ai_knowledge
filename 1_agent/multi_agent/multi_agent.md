...
**Multi-Agent Systems (多代理系統)** 是多個 AI Agent 協作完成複雜任務的架構：
...
│  │                                                              │   │
│  │  優勢:                                                        │   │
│  │  - 專業分工: 每個 Agent 擅長特定任務                         │   │
│  │  - 相互審查: 錯誤可以被其他 Agent 發現                       │   │
│  │  - 可擴展性: 新增 Agent 不影響現有                            │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
...
**為何重要**:
1. **能力擴展**: 透過協作實現超越單一 Agent 的能力
2. **錯誤減少**: 多重檢查和驗證
3. **任務分解**: 複雜問題拆解為可管理的子任務
4. **靈活性**: 可根據任務動態調整 Agent 組合
